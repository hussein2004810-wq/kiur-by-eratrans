export const PERMISSIONS=['manage_catalog','manage_tests','manage_students','manage_teachers','view_reports','import_questions','use_media','export_results','manage_glimpses','manage_library','view_library_log','view_student_log','view_audit_log','view_account_log','request_student_ban','review_student_ban','view_student_ban_log'];
