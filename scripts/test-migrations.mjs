...
if(gamificationTables!==7||gamificationIndexes!==6||!rankPlan.includes('idx_gamification_ledger_season_rank'))throw new Error('Gamification migration verification failed');
