...
assert.equal((source.match(/role="tab" aria-selected=/g)||[]).length,11,'all admin destinations need tab semantics');
...
console.log(JSON.stringify({ok:true,adminTabs:11,initialCss:main,mobileMenu:true,verticalRail:true,reducedMotion:true}));
