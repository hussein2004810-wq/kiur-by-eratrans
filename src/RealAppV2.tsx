...
import {Activity,ArrowLeftRight,BarChart3,Bell,BookOpen,CheckCircle2,ChevronLeft,ClipboardList,Clock3,Contrast,Copy,FileQuestion,GraduationCap,HeartPulse,History,LayoutDashboard,Link2,LogOut,Menu,Minus,Plus,Save,Search,Settings2,ShieldCheck,SlidersHorizontal,Trash2,Trophy,Type,UserRound,Users,X} from 'lucide-react';
import './real.css';
