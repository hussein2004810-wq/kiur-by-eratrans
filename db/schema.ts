export const tables = {
  ...
  tests: ['id','title','subject','lecture','duration_minutes','pass_percentage','status','created_by','created_at','updated_at'],
  questions: ['id','test_id','text','options_json','correct_option','explanation','position'],
  attempts: ['id','user_id','test_id','status','score','max_score','percentage','started_at','last_saved_at','finished_at'],
